...
namespace Ruhul\ArrayQuery\Closure;

use Ruhul\ArrayQuery\Closure\Conditions\ClosureInterface;
...
class WhereClosure
{
    ...
    private static function checkCondition(array $where, array $element): bool
    {
        ...
        $filterClass = "Ruhul\\ArrayQuery\\Closure\\Conditions\\" . self::getFilterClass($where['operator']);
